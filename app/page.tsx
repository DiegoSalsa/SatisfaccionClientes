    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-black dark:via-zinc-900 dark:to-black transition-colors">
      ...
      <main className="max-w-6xl mx-auto px-6 py-16">
        ...
        <section className="text-center mb-20">
          ...
          <p className="text-xl text-gray-600 dark:text-zinc-300 max-w-2xl mx-auto mb-8">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <a 
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-full font-semibold text-lg transition-all hover:scale-105 shadow-lg"
            >
              Ver Demo Encuesta
            </a>
          </div>
        ...
        {/* How it works */}
        <section className="bg-white dark:bg-zinc-900 rounded-3xl p-10 md:p-16 shadow-sm border border-gray-100 dark:border-zinc-800">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-zinc-400 text-sm">Cada negocio tiene una URL única como /encuesta/tu-negocio</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-blue-600 text-white rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4">2</div>
              <h4 className="font-semibold text-gray-800 dark:text-white mb-2">Cliente responde</h4>
              <p className="text-gray-600 dark:text-zinc-400 text-sm">Califican de 1-5 estrellas y dejan un comentario opcional</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-blue-600 text-white rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4">3</div>
              <h4 className="font-semibold text-gray-800 dark:text-white mb-2">Revisa tu dashboard</h4>
              <p className="text-gray-600 dark:text-zinc-400 text-sm">Accede con tu enlace privado y ve todas las opiniones</p>
            </div>
          </div>
        </section>
      </main>
      ...
      {/* Footer */}
      <footer className="text-center py-10 text-gray-500 dark:text-zinc-500 text-sm">
